...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for distribution in livingGhostPositionDistributions:
            most_likely_position = distribution.argMax()  # Find the most likely position of the ghost

            # Find the closest action that minimizes the maze distance to the ghost
            for action in legal:
